      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">
            Quatro acabamentos em titânio lindos para voce escolher
          </p>
        </div>
        ...
        <div className="text-center mt-16">
            <button className="bg-blue-700 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 cursor-pointer mb-8 hover:scale-105 shadow-md shadow-blue-500/50">
                Compre agora á partir de R$9.499,00
            </button>
